    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <img src="../../../../resources/Gaby/private_area/inside/img/Compras/HarryPotter.jpg" class="img-fluid" alt="">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <div class="mb-3">
              <a href="">
                <span class="badge purple mr-1">+15</span>
              </a>
              <a href="">
            ...
            <p>La historia comienza con la celebración del mundo mágico. Durante muchos años, había sido aterrorizado por el malvado mago Lord Voldemort. La noche del 31 de octubre, mató a Lily y James Potter. Sin embargo, cuando intenta matar a su hijo de 1 año, Harry, la maldición asesina Avada Kedavra se vuelve sobre sí mismo.</p>
      ...
      <!--Grid row-->
              ...
              <div class="media d-block d-md-flex mt-3">
                ...
                <div class="media-body text-center text-md-left ml-md-3 ml-0">
                  <h5 class="mt-0 font-weight-bold">Akeno Monticelli
                    ...
                    Hasta fue harto difícil conseguir datos fehacientes acerca de algunos de sus realizadores y protagonistas, pero el nombre original del film que nos ocupa es "Carrie", obviamente sin equivalente linguistico por estos lares; ni siquiera hay registros de que haya tenido una traducción oficial para Estados Unidos.
                </div>
              </div>
              <div class="media d-block d-md-flex mt-3">
        ...
        <!--/.Comentarios-->
          ...
          <div class="card mb-3 wow fadeIn">
            <div class="card-header font-weight-bold">Deja un comentario en la película</div>
              <div class="card-body">
                  <form>
                    <!-- Form -->
                    ...
                    <!-- Email -->
                      <label for="replyFormEmail">Tu correo electrónico</label>
