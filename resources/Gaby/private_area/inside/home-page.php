        ...
        <img src="img/O1.jpg" class="card-img-top" alt="">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              <h1 class="mb-4">
                Próximamente en PopMovies
              <h3 class="mb-4">
                Alicia en el país de las maravillas
              </h1>
              <p class="mb-4 d-none d-md-block">
                Alicia, ahora una joven de 19 años de edad, regresa al País de las Maravillas para encontrar su verdadero destino y terminar con el gobierno de terror de la malvada reina Roja en un sin fin de aventuras.
              </p>
            </div>
            <!-- Content -->
        ...
        <img src="img/O4.jpg" class="card-img-top" alt="">
          ...
          <div class="mask rgba-black-strong d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              ...
              <p class="mb-4 d-none d-md-block">
                Un asesino enmascarado mata a Tree Gelbman. A partir de entonces, ella revive el mismo día desde primera hora de la mañana, una y otra vez, sin lograr averiguar quién la asesina todos los días.
              </p>
            </div>
            <!-- Content -->
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a class="dark-grey-text">Harry Potter y la Piedra Filosofal
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a class="dark-grey-text">Los Juegos del Hambre: Sinsajo Parte 1</a>
                  </strong>
                </h5>
                ...
                <h4 class="font-weight-bold blue-text">
                  <strong>139$</strong>
                	...
                	<a href="hg_view.php" target="_blank" class="btn btn-primary btn-md">VER MÁS
                    </a>
              </div>
              <!--Card content-->
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <h4 class="font-weight-bold blue-text">
                  ...
                  <a href="carrie_view.php" target="_blank" class="btn btn-primary btn-md">VER MÁS
                    </a>
              </div>
              <!--Card content-->
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a class="dark-grey-text">La Huérfana</a>
                  </strong>
                </h5>
                ...
                <h4 class="font-weight-bold blue-text">
                  <strong>219$</strong>
                	...
                	<a href="orphan_view.php" target="_blank" class="btn btn-primary btn-md">VER MÁS
                    </a>
              </div>
              <!--Card content-->
