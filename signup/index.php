...
<body class="grey lighten-3">
  ...
  <!-- Navbar -->
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark mdb-color scrolling-navbar">
    <div class="container">
  ...
  <main class="mt-5 pt-4">
    <div class="container wow fadeIn">
      ...
      <!-- Heading -->
      <h2 class="my-5 h2 text-center">Ingresa tus datos </h2>
          ...
          <div class="card">
            ...
            <form class="card-body">
              ...
              <div class="md-form mb-5">
                <input type="password" id="address" class="form-control" placeholder="• • • • • • •">
                <label for="address" class="">Contraseña</label>
              </div>

              <!--address-2-->
              <div class="md-form mb-5">
                <input type="password" id="address-2" class="form-control" placeholder="• • • • • • •">
                <label for="address-2" class="">Repite la contraseña</label>
              </div>

              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="same-address">
                <label class="custom-control-label" for="same-address">Acepto las condiciones de uso y venta</label>
              </div>
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="save-info">
                <label class="custom-control-label" for="save-info">He leído todos los avisos de cookies.</label>
              </div>

              <hr class="mb-4">
              <button class="btn btn-primary btn-lg btn-block" type="submit">Registrarme ahora</button>
